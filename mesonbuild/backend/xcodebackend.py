...
class XCodeBackend(backends.Backend):
    ...
    def object_filename_from_source(self, target: build.BuildTarget, source: mesonlib.FileOrString, targetdir: str = None) -> str:
    ...
    def generate_xc_build_configuration(self, objects_dict: PbxDict) -> None:
        ...
        for buildtype in self.buildtypes:
            ...
            settings_dict.add_item('BUILD_DIR', '"%s"' % self.environment.get_build_dir())
